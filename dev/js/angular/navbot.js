...
*/
//
unicolored.directive( 'navBot', [ '$rootScope', function( $rootScope ) {
    return {
        restrict: "A",
        templateUrl: "/wp-content/themes/rock-unicolored/js/navbot/navbot.html",
...
unicolored.controller( 'NavbotCtrl', [ '$scope', '$rootScope', 'localStorageService', 'ApplicationsService', '$document', '$window', 'ConsoleService', '$interval',
...
unicolored.directive( 'menuLauncher', function( $animate ) {
    return {
        restrict: "A",
        templateUrl: "/wp-content/themes/rock-unicolored/js/navbot/menu-launcher.html",
        link: function( scope, element, attrs ) {
            $( '.dropdown-toggle' ).dropdown();
            scope.version = version;
            var gravatar = $( '<img class="img-circle img-responsive" style="margin:0 auto;" src="https://www.unicolored.com/img/ico/gravatar.' + version + '.jpg" alt="Gilles Hoarau" />' );
            $( '#theLauncherMenu blockquote' ).prepend( gravatar );
        }
    };
} );
// Bouton de retour en haut de page #gotop
unicolored.directive( 'goTop', function() {
    return {
        restrict: "A",
...
unicolored.directive( 'menuParametres', [ 'localStorageService', '$rootScope', function( localStorageService, $rootScope ) {
    return {
        restrict: "A",
        templateUrl: "/wp-content/themes/rock-unicolored/js/navbot/menu-parametres.html",
        link: function( scope, element, attrs ) {
...
unicolored.directive( 'menuLangues', function() {
    return {
        restrict: "A",
        templateUrl: "/wp-content/themes/rock-unicolored/js/navbot/menu-langues.html",
        link: function( scope, element, attrs ) {
...
*/
// Horloge
unicolored.directive( 'horloge', [ '$interval', 'dateFilter', function( $interval, dateFilter ) {
...
unicolored.directive( 'menuHorloge', function() {
    return {
        restrict: "A",
        templateUrl: "/wp-content/themes/rock-unicolored/js/navbot/menu-horloge.html",
        link: function( scope, element, attrs ) {
            function dateseule() {
                // Création de la date
                date = new Date();
