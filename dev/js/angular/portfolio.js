unicolored.directive( 'imagePortfolio', function() {
    ...
    return {
        ...
        link: function( scope, element, attrs ) {
            ...
            //nbimg++;
            $result = $permalink.html( $( '<img src="https://www.unicolored.com' + attrs.imageurl + '" class="img-responsive" width="344" height="224" alt="Portfolio graphic & web design Paris">' ).hide() );
