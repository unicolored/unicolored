totoro.factory( 'CarouselService', function() {
    var images = [];
            ...
            case "frontpage":
                images = [
                ...
                },*/
                    {
                        "title": "Gilles Hoarau",
                        "img": "services",
                        "url": "https://www.gilleshoarau.com/services-communication-developpement-web/"
                }, {
                        "title": "Services et prestations",
                        "img": "graphisme",
                        "url": "https://www.gilleshoarau.com/portfolio-graphic-web-design-professionnel/"
                }, {
                        "title": "Web design",
                        "img": "webdesign",
                        "url": "https://www.gilleshoarau.com/portfolio-graphic-web-design-professionnel/"
...
totoro.directive( 'carouselFrontpage', [ 'CarouselService', function( CarouselService ) {
    return {
        restrict: 'A',
        link: function() {
            //scope.da = 'indicators';
            ...
            $.each( CarouselService( 'frontpage' ), function( index, value ) {
                var img = value.img;
                //var $image = $( '<img src="https://gilleshoarau.com/img/carousel/' + img + '.jpg" class="img-responsive" itemprop="thumbnailUrl" width="900" height="349" alt="' + value.title + '" >' );
