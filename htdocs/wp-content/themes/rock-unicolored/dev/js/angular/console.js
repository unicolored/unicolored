...
########   ## ##       ######   #######  ##    ##  ######   #######  ######## ########
*/
unicolored.directive( 'console', function() {
    return {
        restrict: "A",
        //templateUrl: "/wp-content/themes/rock-unicolored/js/navbot/console.html",
...
########   ## ##       ######   #######  ##    ##    ##    ##     ##  #######  ######## ######## ######## ##     ##
*/
unicolored.controller( 'ConsoleCtrl', [ '$scope', 'ConsoleService', function( $scope, ConsoleService ) {
    ConsoleService.consoleStart();
} ] );
unicolored.factory( "ConsoleDatas", function() {
    /*
    ...
    */
    ...
    Ins.aide = '<li>Besoin d\'aide ? <span>contact@unicolored.com</span></li>';
    Ins.strings = "";
    Ins.corrections = "";
    Ins.suffix = false;
    datas.Ins = Ins;
...
unicolored.factory( "ConsoleCommandsList", [ 'ConsoleDatas', function( ConsoleDatas ) {
    return {
        /*
...
unicolored.factory( "ConsoleSubmitService", [ 'ConsoleDatas', 'ConsoleCommandsList', function( ConsoleDatas, ConsoleCommandsList ) {
    return {
        /*
...
unicolored.factory( "ConsoleService", [ 'ConsoleSubmitService', 'ConsoleDatas', 'ConsoleCommandsList', function( ConsoleSubmitService, ConsoleDatas, ConsoleCommandsList ) {
    var datas = ConsoleDatas;
    return {
        /*
        ...
        consoleStart: function( container ) {
            ...
            */
            ...
            datas.ghConsole.typed( {
                strings: [ '* * * ^500 <br>' + instructions.connected + navigator.appName + ' (' + navigator.appCodeName + ', ' + navigator.platform + ' ' + navigator.language + ' - ' + navigator.product + ')<br><i>☺</i> unicolored<b class="tp">.com</b> <small>v.' + version + '</small><br>' + instructions.signature + instructions.instructions + instructions.liste + instructions.aide + instructions.space ],
                //strings: [ ' . . . ^100*^100*^100*', '<br> . . . ' + new Date() + '<br> . . . * * * ^500 <br>' + instructions.connected + navigator.appName + ' (' + navigator.appCodeName + ', ' + navigator.platform + ' ' + navigator.language + ' - ' + navigator.product + ')<br><i>☺</i> unicolored<b class="tp">.com</b> <small>v.' + version + '</small><br>' + instructions.signature + instructions.instructions + instructions.liste + instructions.aide + instructions.space ],
                //strings: [ 'Ok' ],
                typeSpeed: 0,
                startDelay: 0,
                backDelay: 0,
