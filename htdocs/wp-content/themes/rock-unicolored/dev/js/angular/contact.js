 ...
 * by Gilles Hoarau
 * */
unicolored.controller( 'ContactCtrl', [ '$scope', '$http', 'FileUploader',
    function( $scope, $http, FileUploader ) {
        ...
        */
        ...
        var uploader = $scope.uploader = new FileUploader( {
            url: 'https://www.unicolored.com/wp-content/themes/rock-unicolored/inc/upload.php',
            autoUpload: false,
        ...
        uploader.onBeforeUploadItem = function( item ) {
            ...
            formData = [ {
                ...
                From: "contact@unicolored.com",
                To: "Gilles Hoarau <contact@unicolored.com>",
                HtmlBody: htmlBody,
...
########   ## ##      ########  #### ##     ## ########  ######     ##    ####    ###    ########  ######
*/
unicolored.directive( 'contact', function() {
    return {
        restrict: "A",
        templateUrl: "/wp-content/themes/rock-unicolored/js/contact/form-contact.html",
        //transclude: true,
    };
} );
