...
/*!
unicolored */
var unicolored=angular.module("unicolored",["ngMaterial","ngRoute","ngSanitize","ngAria"]);unicolored.config(function(){"use strict"}),unicolored.run(function(){"use strict"}),unicolored.controller("BonjourController",["$scope","$http",function(a,b){"use strict";a.world="Gilles",a.articles=[],b({method:"GET",url:"/wp-json/posts/"}).success(function(b,c){a.articles=b,console.log(c)})}]);